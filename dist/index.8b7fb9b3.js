...
_provider.createEventName();
_provider.createEventDate();
_provider.createBtn();
_display.eventChoice(); // const form = document.createElement('form')
...
},{"./provider":"g9T0Y","./display":"bNtsY"}],"g9T0Y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createEventName", ()=>createEventName
);
parcelHelpers.export(exports, "createEventDate", ()=>createEventDate
);
...
},{}],"bNtsY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "eventChoice", ()=>eventChoice
);
var _timeSetting = require("./timeSetting");
let eventChoice = ()=>{
    let storedEvents = JSON.parse(localStorage.getItem('events'));
    if (!storedEvents) storedEvents = [];
        ...
        button.addEventListener('click', function() {
            ...
            console.log(storedEvents);
            let p = document.createElement('p');
            let display = _timeSetting.upcomingTime(event.date, event.name);
            p.innerText = display;
            main.appendChild(p);
        });
    }
...
},{"./timeSetting":"5zrXz","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"5zrXz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "upcomingTime", ()=>upcomingTime
);
let upcomingTime = (date, eventName)=>{
    let timestamp = new Date(date).getTime() - new Date().getTime();
    let readableTimestamps = [
        {
            name: 'week ',
    ...
    let display = '';
    for (const readableTimestamp of readableTimestamps)if (timestamp > readableTimestamp.value) {
        let result = Math.floor(timestamp / readableTimestamp.value);
        timestamp -= result * readableTimestamp.value;
        display += result + ' ' + readableTimestamp.name;
        if (result > 1) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["cSv3F","3auaO"], "3auaO", "parcelRequire8f0c")
